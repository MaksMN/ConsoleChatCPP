...
#undef private
    ...
    void setUserPassword(const std::wstring &pass);
    ...
    /// @param pass
    void copyUserPassword(const std::wstring &pass);
...
public:
    ...
    User(const std::wstring &name, const std::wstring &login) : _name(name), _login(login) {}

    /// @brief init
    /// @param name string name
    /// @param login string login unique!
    /// @param pass string password
    User(const std::wstring &name, const std::wstring &login, const std::wstring &pass);
    ...
    const std::wstring &getUserLogin() const;
    ...
    /// @param name string
    void setUserName(const std::wstring &name); // set the user's name

    /// @brief set the user's login
    /// @param login string
    void setUserLogin(const std::wstring &login); // set the user's login
    ...
    /// @brief Overloading the assignment operator L"="
    /// @param user User to assign struct L"User"
    /// @return User
